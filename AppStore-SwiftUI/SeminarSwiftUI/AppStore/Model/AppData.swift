...
let sampleApps: [AppData] = [
    ...
    AppData(id: UUID(), ranking: 9, title: "비즈니스 네트워크", subtitle: "프로페셔널 네트워킹 앱", tag: "새로운 앱", category: .socialNetwork, price: 500, downloadState: .redownload, iconImage: Image(systemName: "network"), bannerImage: Image(systemName: "banknote")),
    AppData(id: UUID(), ranking: 10, title: "할일메모", subtitle: "일정 관리 및 체크리스트", tag: "새로운 경험", category: .finance, price: 20000, downloadState: .downloaded, iconImage: Image(systemName: "list.bullet.rectangle.portrait"), bannerImage: Image(systemName: "banknote")),
    AppData(id: UUID(), ranking: 11, title: "웃음클럽", subtitle: "재미있는 커뮤니티", tag: "새로운 경험", category: .socialNetwork, price: 100000, downloadState: .download, iconImage: Image(systemName: "face.smiling"), bannerImage: Image(systemName: "banknote")),
    AppData(id: UUID(), ranking: 12, title: "주식분석", subtitle: "투자 포트폴리오 관리", tag: nil, category: .finance, price: 1000, downloadState: .update, iconImage: Image(systemName: "dollarsign.square"), bannerImage: Image(systemName: "banknote")),
    AppData(id: UUID(), ranking: 13, title: "프렌즈챗", subtitle: "전세계 친구와 소통", tag: nil, category: .socialNetwork, price: 9000, downloadState: .redownload, iconImage: Image(systemName: "bubble.left.and.bubble.right"), bannerImage: Image(systemName: "banknote")),
