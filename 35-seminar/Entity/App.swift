...
//        App(iconImage: UIImage(systemName: "wrench.fill")!, ranking: 28, title: "가계부 도구", subtitle: "가계부 자동화 도구", category: .finance, price: 28000, downloadState: .redownload),
//        App(iconImage: UIImage(systemName: "gamecontroller")!, ranking: 29, title: "주식 게임", subtitle: "가상의 주식 거래 게임", category: .finance, price: 40000, downloadState: .update),
